...
circuit.add(
  <board width="82mm" height="54mm" autorouter="sequential-trace">
    ...
    <trace from="RREF_LOW.pin1" to="net.V3V3" />
    <trace from="RREF_LOW.pin2" to="QLOW.pin3" />
    <trace from="QLOW.pin2" to="J2.pin1" />
    <trace from="U1.pin4" to="QLOW.pin1" />
    <trace from="RREF_MID.pin1" to="net.V3V3" />
    <trace from="RREF_MID.pin2" to="QMID.pin3" />
    <trace from="QMID.pin2" to="J2.pin1" />
    <trace from="U1.pin5" to="QMID.pin1" />
    <trace from="RREF_HIGH.pin1" to="net.V3V3" />
    <trace from="RREF_HIGH.pin2" to="QHIGH.pin3" />
    <trace from="QHIGH.pin2" to="J2.pin1" />
    <trace from="U1.pin6" to="QHIGH.pin1" />
    <trace from="J2.pin2" to="net.GND" />

    <trace from="J2.pin1" to="RADC.pin1" />
    <trace from="RADC.pin2" to="U1.pin3" />
    <trace from="CADC.pin1" to="U1.pin3" />
    <trace from="CADC.pin2" to="net.GND" />
    <trace from="D1.pin1" to="U1.pin3" />
    <trace from="D1.pin2" to="net.V3V3" />
    <trace from="D2.pin1" to="net.GND" />
    <trace from="D2.pin2" to="U1.pin3" />

    <trace from="OLED1.pin2" to="net.V3V3" />
    <trace from="OLED1.pin1" to="net.GND" />
    <trace from="OLED1.pin4" to="U1.pin7" />
    <trace from="OLED1.pin3" to="U1.pin8" />
  </board>,
)
